...
export default function PhotosUploader({addedPhotos,onChange}) {
    ...
    async function addPhotoByLink(ev) 
    {
        ...
        if (photoLink.startsWith('http://') || photoLink.startsWith('https://')) {
            const { data: filename } = await axios.post('http://localhost:5000/upload-by-link', { link: photoLink }, { withCredentials:true});
        ...
        // ev.preventDefault();
        // const {data:filename} = await axios.post('http://127.0.0.1:5000/upload-by-link', {link: photoLink})
        // setAddedPhotos(prev => {
    ...
    function uploadPhoto(ev) { 
        ...
        axios.post('http://localhost:5000/upload', data, { withCredentials:true}, {
        ...
        // {
        //     const uploadedFiles = response.data.map(file => file.filename);
        ...
        <>
            <div className="flex gap-2">
                <input value={photoLink} 
                    ...
                    type="text" placeholder={'Add using a link ...jpg'} className="w-full border border-gray-300 my-1 py-2 px-3 rounded-2xl"/>
            ...
            <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                ...
                <label className="h-32 cursor-pointer flex items-center gap-1 justify-center border border-gray-300 bg-transparent rounded-2xl p-2 text-2xl text-gray-600">
